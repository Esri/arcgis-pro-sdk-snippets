...
namespace ProSnippets.UtilityNetworkSnippets
{
  /// <summary>
  /// This class provides code snippets for using the Utility Network APIs in the ArcGIS Pro SDK for .NET.
  /// </summary>
  /// <remarks>
  /// The following code snippets demonstrate the use of Utility Network APIs within the ArcGIS Pro SDK.
  ...
  /// </remarks>
  static partial class ProSnippetsUtilityNetwork
  {
    static readonly string _diagramName = "WaterNetworkDiagram";
    static readonly string TemplateName = "WaterNetworkDiagramTemplate";
