...
namespace ProSnippets.EditingSnippets
{
  public static partial class ProSnippetsEditing
  {
    ...
    public static async Task ProSnippetsEditingOptionsAsync()
    {
      ...
      // cref: ArcGIS.Desktop.Core.EditingOptions.GetFallbackTools()
      // cref: ArcGIS.Desktop.Core.EditingOptions.FallbackTool
      #region Default or Fallback Tools
      {
