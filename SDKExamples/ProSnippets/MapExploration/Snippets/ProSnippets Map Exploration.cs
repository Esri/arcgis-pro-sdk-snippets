...
namespace ProSnippets.MapExplorationSnippets
{
  ...
  public static partial class ProSnippetsMapExploration
  {
    ...
    public static void MapExplorationProSnippets()
    {
      ...
      #region Zoom Async To Full Extent
      {
        //Zoom to the map's full extent
      ...
      #region Return coordinates of the point clicked in the map
      {
        // Note: Needs QueuedTask to run
        {
          //Convert the clicked point in client coordinates to the corresponding map coordinates.
          var mapPoint = MapView.Active.ClientToMap(clientPoint);
      ...
      // cref: ArcGIS.Desktop.Mapping.MapView.FlashFeature(ArcGIS.Desktop.Mapping.SelectionSet)
      #region Identify the features that intersect a geometry
      {
        // Note: Needs QueuedTask to run
        {
          //Get all the features that intersect the geometry and flash them in the view. 
