...
namespace ProSnippets.GeoDatabaseSnippets
{
  static partial class ProSnippetsGeoDatabase
  {
    /// <summary>
    /// This class provides code snippets for using the Geodatabase APIs in the ArcGIS Pro SDK for .NET.
    /// </summary>
    /// <remarks>
    /// These code snippets illustrate how to use Geodatabase APIs in the ArcGIS Pro SDK.
    /// Each region in the method contains a specific code snippet that demonstrates a particular functionality.
    /// Note: The Pro SDK Add-in may require certain code snippets to execute on the ArcGIS Pro Main CIM (MCT) thread or the UI thread.
    ...
    /// </remarks>
    public static async void ProSnippetsGeoDatabaseAsync()
    {
      ...
      {
        static void OpenEnterpriseGeodatabase()
        {
      ...
      static void OpenEnterpriseGeodatabaseUsingSDEFilePath()
      {
      ...
      {
        static void ObtainingGeodatabaseFromProjectItem()
        {
      ...
      {
        static void GettingConnectionProperties()
        {
      ...
      {
        static void ObtainingGeodatabaseFromFeatureLayer()
        {
      ...
      #region Executing SQL Statements
      {
        ...
        static void ExecuteSQLOnGeodatabase(Geodatabase geodatabase, string statement)
        {
      ...
      {
        static void ObtainingDefinitionFromGeodatabase()
        {
          using (Geodatabase geodatabase = new Geodatabase(new DatabaseConnectionFile(new Uri("path\\to\\sde\\file\\sdefile.sde"))))
          {
      ...
      {
        static void ObtainingDefinitionsFromGeodatabase()
        {
          using (Geodatabase geodatabase = new Geodatabase(new DatabaseConnectionFile(new Uri("path\\to\\sde\\file\\sdefile.sde"))))
          {
      ...
      {
        static void ObtainingRelatedDefinitionsFromGeodatabase()
        {
      ...
      #region Getting a Table Definition from a Layer
      {
        ...
        static TableDefinition GetDefinitionFromLayer(FeatureLayer featureLayer)
        {
      ...
      {
        static void OpeningDatasetsFromGeodatabase()
        {
          using (Geodatabase geodatabase = new Geodatabase(new DatabaseConnectionFile(new Uri("path\\to\\sde\\file\\sdefile.sde"))))
          {
      ...
      {
        static bool TableExists(Geodatabase geodatabase, string tableName)
        {
          try
          {
      ...
      {
        static bool FeatureClassExists(Geodatabase geodatabase, string featureClassName)
        {
          try
          {
      ...
      #region Opening RelationshipClass between two Tables
      {
        ...
        static IReadOnlyList<RelationshipClass> OpenRelationshipClassFeatureServices(Geodatabase geodatabase, string originClass, string destinationClass)
        {
      ...
      {
        static void GetFeatureClassesInRelationshipClassAsync()
        {
          using (Geodatabase geodatabase = new Geodatabase(new FileGeodatabaseConnectionPath(new Uri(@"C:\Data\LocalGovernment.gdb"))))
          {
            IReadOnlyList<RelationshipClassDefinition> relationshipClassDefinitions = geodatabase.GetDefinitions<RelationshipClassDefinition>();
      ...
      {
        static void OpenShapefileFeatureClass()
        {
      ...
      {
        static void OpenCADFeatureClass()
        {
      ...
      {
        static void SearchingATableUsingQueryFilter()
        {
          try
          {
            using (Geodatabase geodatabase = new Geodatabase(new DatabaseConnectionFile(new Uri("path\\to\\sde\\file\\sdefile.sde"))))
      ...
      {
        static void SearchingATableWithNonLatinCharacters()
        {
          using (Geodatabase geodatabase = new Geodatabase(new DatabaseConnectionFile(new Uri("path\\to\\sde\\file\\sdefile.sde"))))
      ...
      {
        static RowCursor SearchingATable(Table table, IReadOnlyList<long> objectIDs)
        {
          QueryFilter queryFilter = new QueryFilter()
          {
            ObjectIDs = objectIDs
      ...
      {
        static void SearchingAFeatureClass()
        {
          using (Geodatabase geodatabase = new Geodatabase(new DatabaseConnectionFile(new Uri("path\\to\\sde\\file\\sdefile.sde"))))
      ...
      {
        static void SelectingRowsFromATable()
        {
          using (Geodatabase geodatabase = new Geodatabase(new DatabaseConnectionFile(new Uri("path\\to\\sde\\file\\sdefile.sde"))))
      ...
      {
        static void SelectingFeaturesFromAFeatureClass()
        {
          using (Geodatabase geodatabase = new Geodatabase(new DatabaseConnectionFile(new Uri("path\\to\\sde\\file\\sdefile.sde"))))
      ...
      #region Gets the count of  a Table  or FeatureClass
      {
        static void GetCount(FeatureLayer featureLayer)
        {
      ...
      {
        static RowCursor SortWorldCities(FeatureClass worldCitiesTable)
        {
      ...
      #region Calculating Statistics on a Table
      {
        ...
        static void CalculateStatistics(FeatureClass countryFeatureClass)
        {
      ...
      {
        static void JoiningWithWhereQueryDef()
        {
          using (Geodatabase geodatabase = new Geodatabase(new DatabaseConnectionFile(new Uri("path\\to\\sde\\file"))))
          {
            ...
            using (RowCursor rowCursor = geodatabase.Evaluate(municipalEmergencyFacilitiesQueryDef, false))
            {
              while (rowCursor.MoveNext())
              {
                using (Row row = rowCursor.Current)
                {
                  ...
                  IReadOnlyList<Field>
                    fields = feature.GetFields(); //Contains one ArcGIS.Core.Data.Field objects for every subfield
                }
              }
            }
          }
      ...
      {
        static void EvaluatingQueryDefWithOuterJoin()
        {
          using (Geodatabase geodatabase = new Geodatabase(new DatabaseConnectionFile(new Uri("path\\to\\sde\\file"))))
          {
      ...
      {
        static void EvaluatingQueryDefWithInnerJoin()
        {
          using (Geodatabase geodatabase = new Geodatabase(new DatabaseConnectionFile(new Uri("path\\to\\sde\\file"))))
          {
      ...
      {
        static void EvaluatingQueryDefWithNestedJoin()
        {
          using (Geodatabase geodatabase = new Geodatabase(new DatabaseConnectionFile(new Uri("path\\to\\sde\\file"))))
          {
            QueryDef queryDef = new QueryDef()
      ...
      {
        static void DefaultQueryDescription()
        {
      ...
      {
        static void CustomQueryDescription()
        {
          DatabaseConnectionProperties databaseConnectionProperties = new DatabaseConnectionProperties(EnterpriseDatabaseType.SQLServer)
          {
            AuthenticationMode = AuthenticationMode.DBMS,
      ...
      {
        static void JoinQueryDescription()
        {
          DatabaseConnectionProperties databaseConnectionProperties = new DatabaseConnectionProperties(EnterpriseDatabaseType.SQLServer)
          {
            AuthenticationMode = AuthenticationMode.DBMS,
      ...
      {
        static void MultiGeometryQueryDescription()
        {
          DatabaseConnectionProperties databaseConnectionProperties = new DatabaseConnectionProperties(EnterpriseDatabaseType.SQLServer)
          {
            AuthenticationMode = AuthenticationMode.DBMS,
      ...
      {
        static void SqliteQueryDescription()
        {
      ...
      {
        static void UsingSqlSyntaxToFormPlatformAgnosticQueries()
        {
          using (Geodatabase geodatabase = new Geodatabase(new FileGeodatabaseConnectionPath(new Uri("C:\\Data\\LocalGovernment.gdb"))))
      ...
      {
        static void JoiningFileGeodatabaseFeatureClassToOracleQueryLayer()
        {
          using (Geodatabase geodatabase = new Geodatabase(new FileGeodatabaseConnectionPath(new Uri("C:\\Data\\LocalGovernment.gdb"))))
          ...
          {
            Field originPrimaryKey = leftFeatureClass.GetDefinition().GetFields()
              .FirstOrDefault(field => field.Name.Equals("facilityId"));

            Field destinationForeignKey = rightTable.GetDefinition().GetFields()
              .FirstOrDefault(field => field.Name.Equals("hospitalID"));
      ...
      {
        static void JoinTablesFromDifferentGeodatabases()
        {
          ...
          {
            Field primaryKeyField = sourceTable.GetDefinition().GetFields()
              .FirstOrDefault(field => field.Name.Equals("State.State_Abbreviation"));
            Field foreignKeyField = destinationTable.GetDefinition().GetFields()
              .FirstOrDefault(field => field.Name.Equals("Cities.State"));

            VirtualRelationshipClassDescription virtualRelationshipClassDescription = new VirtualRelationshipClassDescription(primaryKeyField, foreignKeyField,
      ...
      {
        static void QueryTableJoinWithVersionedData()
        {
          QueryDef queryDef = new QueryDef
          {
      ...
      {
        static bool CheckColumnForNull(Row row, Field field)
        {
      ...
      {
        static string GetDomainStringFromField(Row row, Field field)
        {
      ...
      {
        static void GetDatastoreProperties(Datastore geodatabase)
        {
      ...
      {
        static void QueryFilterWithPagination(Table table, List<long> objectIDs)
        {
      ...
      {
        static void GetVersionConflictsInfoInUpdateDeleteType(ServiceConnectionProperties featureServiceConnectionProperties, string featureClassName)
        {
      ...
      {
        static void ExploreContingentValues(Table table)
        {
          using (TableDefinition tableDefinition = table.GetDefinition())
          {
      ...
      {
        static void ValidateContingentValues(FeatureClass parcels, string zoningFieldName = "Zone", string taxCodeFieldName = "TaxCode")
        {
      ...
      {
        static void GetPossibleContingentValues(FeatureClass parcels, string zoningFieldName = "Zone")
        {
          using (RowBuffer rowBuffer = parcels.CreateRowBuffer())
          {
      ...
      {
        static void WritingIntoGuidColumn(Row row, Field field, Guid guid)
        {
      ...
      {
        static void DeletingARowOrFeature()
        {
          string message = String.Empty;
      ...
      {
        static void SplitALineByPoint(FeatureClass lineFeatureClass, MapPoint xPoint)
        {
      ...
      #region Adding Attachments
      {
        ...
        static MemoryStream CreateMemoryStreamFromContentsOf(String fileNameWithPath)
        {
      ...
      {
        static void UpdatingAttachments()
        {
          using (Geodatabase geodatabase = new Geodatabase(new DatabaseConnectionFile(new Uri("path\\to\\sde\\file\\sdefile.sde"))))
      ...
      {
        static void DeletingAttachments()
        {
          using (Geodatabase geodatabase = new Geodatabase(new DatabaseConnectionFile(new Uri("path\\to\\sde\\file\\sdefile.sde"))))
      ...
      {
        static void WriteBlobField(Table table, string blobFieldName, string imageFileName)
        {
      ...
      {
        static void ReadBlobField(Table table, QueryFilter queryFilter, string blobFieldName)
        {
      ...
      {
        static void GettingRowsRelatedByRelationshipClass()
        {
          using (Geodatabase geodatabase = new Geodatabase(new DatabaseConnectionFile(new Uri("path\\to\\sde\\file"))))
        ...
        static void Dispose(IEnumerable<Row> rows)
        {
      ...
      {
        static void CreatingARelationship()
        {
          using (Geodatabase geodatabase = new Geodatabase(new DatabaseConnectionFile(new Uri("path\\to\\sde\\file"))))
          ...
          using (FeatureClass overviewFeatureClass = geodatabase.OpenDataset<FeatureClass>("LocalGovernment.GDB.CIPProjectsOverview"))
          {
            ...
            editOperation.Callback(context =>
            {
              // The rows are being added to illustrate adding relationships.
              // If one has existing rows, those can be used to add a relationship.
      ...
      {
        static void DeletingARelationship()
        {
          using (Geodatabase geodatabase = new Geodatabase(new DatabaseConnectionFile(new Uri("path\\to\\sde\\file"))))
          using (RelationshipClass relationshipClass = geodatabase.OpenDataset<RelationshipClass>("LocalGovernment.GDB.luCodeViolationHasInspections"))
          using (FeatureClass violationsFeatureClass = geodatabase.OpenDataset<FeatureClass>("LocalGovernment.GDB.luCodeViolation"))
            ...
            using (RowCursor rowCursor = violationsFeatureClass.Search(queryFilter, false))
            {
              ...
              using (Row jeffersonAveViolation = rowCursor.Current)
              {
                IReadOnlyList<Row> relatedDestinationRows = relationshipClass.GetRowsRelatedToOriginRows(new List<long>
                    { jeffersonAveViolation.GetObjectID() });
      ...
      {
        static void CreatingAnAnnotationFeature(Geodatabase geodatabase)
        {
      ...
      {
        static Geodatabase ConnectToVersion(Geodatabase geodatabase, string versionName)
        {
      ...
      {
        static void ReconcileAndPost(Geodatabase geodatabase)
        {
      ...
      {
        static void ReconcileAndPost2(Geodatabase geodatabase)
        {
          // Get a reference to our version and our parent
          if (geodatabase.IsVersioningSupported())
          {
      ...
      {
        static void WorkingWithVersions()
        {
          using (Geodatabase geodatabase = new Geodatabase(new DatabaseConnectionFile(new Uri("path\\to\\sde\\file"))))
          using (VersionManager versionManager = geodatabase.GetVersionManager())
          {
      ...
      {
        static Version FindDefaultVersion(Geodatabase geodatabase)
        {
          ...
          static bool IsDefaultVersion(Version version)
          {
          ...
          static Version GetDefaultVersion(Version version)
          {
      ...
      {
        static Version CreateVersion(Geodatabase geodatabase, string versionName, string description, VersionAccessType versionAccessType)
        {
          if (!geodatabase.IsVersioningSupported()) return null;
      ...
      {
        static HistoricalVersion CreateHistoricalVersion(Geodatabase geodatabase, string versionName)
        {
          using (VersionManager versionManager = geodatabase.GetVersionManager())
          {
      ...
      {
        static void ChangeVersions(Geodatabase geodatabase, string toVersionName)
        {
          using (VersionManager versionManager = geodatabase.GetVersionManager())
          {
      ...
      {
        static void PartialPostingSnippet(Version designVersion, FeatureClass supportStructureFeatureClass, List<long> deletedSupportStructureObjectIDs)
        {
      ...
      {
        static void IterateDatasetsFromAFeatureDataset(Geodatabase geodatabase, string featureDatasetName = "City", string featureClassInFeatureDataset = "Buildings")
        {
      ...
      {
        static void GetAttributeRules(Geodatabase geodatabase, string tableName)
        {
          using (TableDefinition tableDefinition = geodatabase.GetDefinition<TableDefinition>(tableName))
          {
      ...
      {
        static void CreateRowBufferFromARow(Table table)
        {
      ...
      {
        static void ExtensionIds1(Table table)
        {
      ...
      {
        static void CreateTableSnippet(Geodatabase geodatabase, CodedValueDomain inspectionResultsDomain)
        {
      ...
      {
        static void CreateFeatureClassSnippet(Geodatabase geodatabase, FeatureClass existingFeatureClass,
      ...
      {
        static void DeleteTableSnippet(Geodatabase geodatabase, Table table)
        {
      ...
      {
        static void DeleteFeatureClassSnippet(Geodatabase geodatabase, FeatureClass featureClass)
        {
      ...
      {
        static void OpenMemoryGeodatabase()
        {
      ...
      {
        static void CreateMemoryGeodatabaseSnippet()
        {
      ...
      {
        static void DeleteMemoryGeodatabaseSnippet()
        {
          // Create the memory connection properties to connect to default memory geodatabase
          MemoryConnectionProperties memoryConnectionProperties = new MemoryConnectionProperties();
      ...
      {
        static void CreateFileGeodatabaseSnippet()
        {
      ...
      {
        static void DeleteFileGeodatabaseSnippet()
        {
      ...
      {
        static void CreateMobileGeodatabase()
        {
      ...
      {
        static void DeleteMobileGeodatabase()
        {
      ...
      {
        static void CreateRangeDomainSnippet(Geodatabase geodatabase)
        {
      ...
      {
        static void CreateCodedDomainSnippet(Geodatabase geodatabase)
        {
          // Create a CodedValueDomain description for water pipes
          CodedValueDomainDescription codedValueDomainDescription = new CodedValueDomainDescription("WaterPipeTypes",
            FieldType.String, new SortedList<object, string> { { "C_1", "Copper" }, { "S_2", "Steel" } })
          {
      ...
      {
        static void CreateFeatureDatasetSnippet(Geodatabase geodatabase)
        {
      ...
      {
        static void DeleteFeatureDatasetSnippet(Geodatabase geodatabase)
        {
      ...
      {
        static void RenameFeatureDatasetSnippet(Geodatabase geodatabase)
        {
      ...
      {
        static void CreateFeatureDatasetWithFeatureClassSnippet(Geodatabase geodatabase)
        {
      ...
      {
        static void CreateFeatureClassInsideFeatureDatasetSnippet(Geodatabase geodatabase)
        {
      ...
      {
        static void AddFeatureClassToFeatureDatasetSnippet(Geodatabase geodatabase)
        {
      ...
      {
        static void RenameTableSnippet(Geodatabase geodatabase)
        {
      ...
      {
        static void AddFieldsInFeatureClassSnippet(Geodatabase geodatabase)
        {
      ...
      {
        static void AddFieldWithDomainSnippet(Geodatabase geodatabase)
        {
      ...
      {
        static void RemoveFieldTableSnippet(Geodatabase geodatabase)
        {
      ...
      {
        static void CreateStandAloneAnnotationFeatureClass(Geodatabase geodatabase, SpatialReference spatialReference)
        {
      ...
      {
        static void CreateFeatureLinkedAnnotationFeatureClass(Geodatabase geodatabase,
          SpatialReference spatialReference)
        {
      ...
      {
        static void CreateAnnotationFeatureClassUsingExistingAnnotationFeatureClassInDataset(Geodatabase geodatabase)
        {
      ...
      // cref: ArcGIS.Core.Data.DDL.AnnotationFeatureClassDescription.#ctor(System.String,ArcGIS.Core.Data.Mapping.AnnotationFeatureClassDefinition)
      // cref: ArcGIS.Core.Data.DDL.AnnotationFeatureClassDescription.#ctor(ArcGIS.Core.Data.Mapping.AnnotationFeatureClassDefinition)
      // cref: ArcGIS.Core.Data.DDL.AnnotationFeatureClassDescription
      #region Creating  a dimension feature class
      {
        static void CreateDimensionFeatureClass(Geodatabase geodatabase)
        {
          ...
          static List<CIMDimensionStyle> GetCIMDimensionStyles()
          {
          ...
          static CIMFill DefaultFill(CIMColor color)
          {
          ...
          static CIMStroke DefaultStroke(CIMColor color, double width = 1)
          {
          ...
          static CIMPolygonSymbol GetPolygonSymbol(CIMColor fillColor, CIMColor outlineColor, double outlineWidth)
          {
          ...
          static CIMLineSymbol GetLineSymbol(CIMColor color, double width)
          {
          ...
          static Polygon CreateArrowGeometry()
          {
            double x = 2.39;
            double y = 1.20;
            double xMod = 0.3;
          ...
          static CIMPointSymbol GetMarkerSymbol(CIMColor color)
          {
          ...
          static CIMTextSymbol GetDefaultTextSymbol(double height)
          {
      ...
      {
        static Geodatabase GetMemoryGeodatabase()
        {
      ...
      {
        static void FindSpatiallyRelatedFeaturesUsingDE9IMPredicate(Geodatabase geodatabase, FeatureClass polygonFeatureClass, FeatureClass polylineFeatureClass)
        {
      ...
      {
        static bool IsTableVersioned(Geodatabase geodatabase, string tableName)
        {
      ...
      {
        static void CreatingTableWithIndex(SchemaBuilder schemaBuilder)
        {
      ...
      {
        static void AddingIndexes(SchemaBuilder schemaBuilder, FeatureClassDefinition featureClassDefinition)
        {
      ...
      {
        static void RemoveAttributeIndex(SchemaBuilder schemaBuilder, FeatureClassDefinition featureClassDefinition, string attributeIndexName)
        {
      ...
      {
        static void RemoveSpatialIndex(SchemaBuilder schemaBuilder, FeatureClassDefinition featureClassDefinition)
        {
      ...
      {
        static void ModifyDomain(Geodatabase geodatabase, string codedValueDomainName = "Pipe")
        {
          SchemaBuilder schemaBuilder = new SchemaBuilder(geodatabase);
      ...
      {
        static void RenameDomain(Geodatabase geodatabase, string rangeDomainOldName = "PipeDiameter", string rangeDomainNewName = "PipeDiam")
        {
          SchemaBuilder schemaBuilder = new SchemaBuilder(geodatabase);
      ...
      {
        static void DeleteDomain(Geodatabase geodatabase, string domainNameToBeDeleted = "PipeMaterial")
        {
          SchemaBuilder schemaBuilder = new SchemaBuilder(geodatabase);
      ...
      {
        static void CreateTableWithSubtypes(SchemaBuilder schemaBuilder)
        {
      ...
      {
        static void DeleteSubtypeField(SchemaBuilder schemaBuilder, FeatureClassDefinition featureClassDefinition)
        {
          FeatureClassDescription featureClassDescription = new FeatureClassDescription(featureClassDefinition);
      ...
      {
        static void ModifySubtypes(SchemaBuilder schemaBuilder, TableDefinition tableDefinition)
        {
      ...
      {
        static void CreateRelationshipWithRelationshipRules(SchemaBuilder schemaBuilder)
        {
      ...
      {
        static void CreateAttributedRelationship(SchemaBuilder schemaBuilder)
        {
          // Creating a 'BuildingType' table with two fields - BuildingType and BuildingTypeDescription
          FieldDescription buildingType = FieldDescription.CreateIntegerField("BuildingType");
          FieldDescription buildingTypeeDescription = FieldDescription.CreateStringField("BuildingTypeDescription", 100);
      ...
      {
        static void ModifyRelationshipClass(SchemaBuilder schemaBuilder, AttributedRelationshipClassDefinition attributedRelationshipClassDefinition)
        {
      ...
      {
        static void DeleteRelationshipClass(SchemaBuilder schemaBuilder, RelationshipClassDefinition relationshipClassDefinition)
        {
      ...
      {
        static void MoveRelationshipClass(SchemaBuilder schemaBuilder, FeatureDatasetDefinition featureDatasetDefinition, RelationshipClassDefinition relationshipClassDefinition)
        {
          FeatureDatasetDescription featureDatasetDescription = new FeatureDatasetDescription(featureDatasetDefinition);
      ...
      {
        static void ModifyAnnotationLabelAndSymbols(SchemaBuilder schemaBuilder, AnnotationFeatureClassDefinition annotationFeatureClassDefinition)
        {
      ...
      {
        static void Rename(SchemaBuilder schemaBuilder, AnnotationFeatureClassDefinition annotationFeatureClassDefinition, string featureClassNewName)
        {
          AnnotationFeatureClassDescription annotationFeatureClassDescription = new AnnotationFeatureClassDescription(annotationFeatureClassDefinition);
      ...
      {
        static void ModifyExistingField(SchemaBuilder schemaBuilder, TableDefinition tableDefinition, string fieldNameToBeModified = "PropertyAddress")
        {
