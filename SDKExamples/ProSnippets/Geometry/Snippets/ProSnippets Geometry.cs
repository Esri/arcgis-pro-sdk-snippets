...
using AreaUnit = ArcGIS.Core.Geometry.AreaUnit;
...
namespace ProSnippets.GeometrySnippets
{
  public static partial class ProSnippetsGeometry
  {
    /// <summary>
    ...
    /// </remarks>
    public static void GeometryProSnippets()
    {
      ...
      Geometry geometry = polygon as Geometry;

      //LineSegment
      LineSegment lineSegment = LineBuilderEx.CreateLineSegment(new Coordinate2D(100, 100), new Coordinate2D(50, 50));

      // BuilderEx convenience methods don't need to run on the MCT
      CubicBezierSegment bezierSegment = CubicBezierBuilderEx.CreateCubicBezierSegment(points);

      // EllipticArcSegment
      MapPoint fromPoint = MapPointBuilderEx.CreateMapPoint(2, 1);
      MapPoint toPoint = MapPointBuilderEx.CreateMapPoint(1, 2);
      Coordinate2D interiorPt = new Coordinate2D(1 + Math.Sqrt(2) / 2, 1 + Math.Sqrt(2) / 2);
      EllipticArcSegment ellipticArcSegment = EllipticArcBuilderEx.CreateCircularArc(fromPoint, toPoint, interiorPt);
      ...
      //Note: Refer to the snippets below for various way to create multipatch geometries
      ...
      #endregion
      // cref: ArcGIS.Core.Geometry.Envelope.Expand(System.Double,System.Double,System.Boolean)
      // cref: ArcGIS.Core.Geometry.EnvelopeBuilderEx.#ctor(System.Double,System.Double,System.Double,System.Double,ArcGIS.Core.Geometry.SpatialReference)
      // cref: ArcGIS.Core.Geometry.EnvelopeBuilderEx.Expand(System.Double,System.Double,System.Boolean)
      // cref: ArcGIS.Core.Geometry.EnvelopeBuilderEx.ToGeometry
