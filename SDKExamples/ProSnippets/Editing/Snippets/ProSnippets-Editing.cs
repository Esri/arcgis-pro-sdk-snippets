...
namespace ProSnippets.EditingSnippets
{
  ...
  public static partial class ProSnippetsEditing
  {
    ...
    /// </summary>
    public static async Task ProSnippetsEditOperationsAsync()
    {
      ...
      await QueuedTask.Run(() =>
      {
        ...
        foreach (var (X, Y, StopOrder, FacilityID) in csvData)
        {

          //Create the point geometry
          ArcGIS.Core.Geometry.MapPoint newMapPoint =
              ArcGIS.Core.Geometry.MapPointBuilderEx.CreateMapPoint(X, Y);
