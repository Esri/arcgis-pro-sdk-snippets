...
{
  public static class SnippetsSceneLayer
  {
    ...
    /// <summary>
    /// Creates a scene layer from a specified URL and adds it to the current scene.
    /// </summary>
    public static async void CreateASceneLayer()
    {
