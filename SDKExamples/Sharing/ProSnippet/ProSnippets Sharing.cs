...
namespace ProSnippets.SharingSnippets
{
  /// <summary>
  /// This methods has a collection of code snippets related to working with ArcGIS Pro Map Sharing functionality.
  /// </summary>
  /// <remarks>
  /// The code snippets in this class are intended to be used as examples of how to work with Sharing functionality in ArcGIS Pro.
  ...
  public static partial class ProSnippetsSharing
  {
    public async static void SharingProSnippets()
    {
      #region ignore - Variable initialization
      //Get the Portal
      var portal = ArcGISPortalManager.Current.GetActivePortal();
      portal = ArcGISPortalManager.Current.GetPortal(new Uri("http://myportal.esri.com/portal/", UriKind.Absolute));

      //Get the user name of the signed in user
      string signOnUserName = portal.GetSignOnUsername();

      //Get user content for the signed in user
      var userContent = await portal.GetUserContentAsync(signOnUserName);
